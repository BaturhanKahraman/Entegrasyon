...
public class StorefrontTwoFactorTests : BaseTest
{
    ...
    {
        _sut = new StorefrontAuthManager(mockContextFactory.Object, Moq.Mock.Of<Entegrasyon.Business.Abstract.IStorefrontEmailService>(), Microsoft.Extensions.Options.Options.Create(new Entegrasyon.Business.FeatureFlags.NotificationFeatureFlags { PublishEnabled = false }));
    }
