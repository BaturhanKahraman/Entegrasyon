...
/// <summary>
/// CiceksepetiBatchStatusPollingService unit testleri.
/// Background servisler tam anlamıyla unit test edilmesi güçtür —
/// instantiation ve scope creation odaklı testler yeterlidir.
/// </summary>
public class CiceksepetiBatchStatusPollingServiceTests
{
    private readonly Mock<IServiceScopeFactory> _mockScopeFactory = new();
    private readonly Mock<ITenantRegistry> _mockTenantRegistry = new();
    private readonly Mock<ILogger<CiceksepetiBatchStatusPollingService>> _mockLogger = new();

    public CiceksepetiBatchStatusPollingServiceTests()
    {
        _mockTenantRegistry
