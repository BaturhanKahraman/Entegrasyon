window.addEventListener("load", function(){
    ...
    var settingsObject = {
        ...
        settings: {
            layout: {
                ...
                boxed: false,
                logo: {
                    darkLogo: '/img/logo-1.png',
                    lightLogo: '/img/logo-1.png'
                }
            }
        },
        reset: false
    ...
    if (equationThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '/img/logo-1.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
        ...
        if (!getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo')) {
                    document.querySelector('.navbar-logo').setAttribute('src', '../../src/assets/img/logo-2.png')
                }
            } else {
                if (document.querySelector('.navbar-logo')) {
