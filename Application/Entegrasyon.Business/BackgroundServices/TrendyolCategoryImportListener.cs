...
public class TrendyolCategoryImportListener:BackgroundService
{
    private IModel _model;
    private readonly IServiceProvider _serviceProvider;
    private readonly ILogger<TrendyolCategoryImportListener> _logger;
    private readonly RabbitMQClientService _clientService;
    public TrendyolCategoryImportListener(IServiceProvider serviceProvider, ILogger<TrendyolCategoryImportListener> logger, RabbitMQClientService clientService)
    {
