...
export var sidenavs:SideNavItemsModel[] =[
    ...
    {claimName:'product',content:'Ürünler',matIcon:'hive',routerLink:'/products',order:2,IsBottom:false},
    ...
    {claimName:'log',content:'Sistem Kayıtları',matIcon:'view_headline',routerLink:'/logs',order:12,IsBottom:true},
